...
public class OrgChart {
    ...
    public Set<Employee> getAllEmployees() {
        Set<Employee> employees = orgChart.stream()
    ...
    public Set<Manager> getAllManagers() {
        Set<Manager> managers = getAllEmployees().stream()
    ...
    public Set<Employee> getDirectSubordinates(Manager manager) {
        Set<Employee> subordinates = getAllEmployees().stream()
                .filter(employee -> employee.getManager() == manager)
                .collect(Collectors.toSet());
        return subordinates;
    }
    ...
    public Map<Manager, Set<Employee>> getFullHierarchy() {
        ...
        for (Manager manager : getAllManagers()) {
            fullHierarchy.put(manager, getDirectSubordinates(manager));
        }
